        ...
        <div class="friend-info friend-info-link" data-role="profile-link" data-user-id="${user.userId}">
            ...
            <div class="friend-stats">
                <div class="friend-stat">
                    <span class="friend-stat-icon">🏃</span>
                    <span>최근 활동: 오늘</span>
                </div>
            </div>
        </div>
