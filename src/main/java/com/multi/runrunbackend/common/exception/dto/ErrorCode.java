...
public enum ErrorCode {
  ...
  RUNNING_RESULT_PROCESSING(HttpStatus.ACCEPTED, "RUN_001", "러닝 결과 처리중입니다. 잠시만 기다려주세요."),
  ...
  ALREADY_PARTICIPATED_SAME_DAY(HttpStatus.BAD_REQUEST, "R018",
      "이미 해당 날짜에 참가한 모집글이 있습니다. 하루에 하나의 모집글만 참가할 수 있습니다."),
  /*=====러닝결과=====*/
  ...
  /*====GPS====*/
  START_GATE_LOCATION_REQUIRED(
      HttpStatus.BAD_REQUEST,
      "G001",
      "출발점 20m 이내에서만 시작할 수 있습니다. 위치 권한을 허용해주세요."
  ),

  START_GATE_LOW_ACCURACY(
      HttpStatus.BAD_REQUEST,
      "G002",
      "GPS 정확도가 낮아 시작할 수 없습니다. 출발점 근처에서 잠시 대기 후 다시 시도해주세요."
  ),
