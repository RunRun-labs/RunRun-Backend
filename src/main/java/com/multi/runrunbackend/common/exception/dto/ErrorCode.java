...
public enum ErrorCode {
  ...
  ALREADY_BLOCKED(
    ...
    /* ===== 토스 API ===== */
    TOSS_API_FAILED(HttpStatus.BAD_GATEWAY, "T001", "토스페이먼츠 API 호출에 실패했습니다."),
    /* ===== 빌링키 ===== */
    BILLING_KEY_ISSUE_FAILED(HttpStatus.BAD_GATEWAY, "B001", "빌링키 발급에 실패했습니다."),
    BILLING_PAYMENT_FAILED(HttpStatus.BAD_GATEWAY, "B002", "빌링키 결제에 실패했습니다."),
    BILLING_KEY_NOT_FOUND(HttpStatus.NOT_FOUND, "B003", "빌링키를 찾을 수 없습니다."),
