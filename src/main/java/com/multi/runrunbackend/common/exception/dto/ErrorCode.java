...
public enum ErrorCode {
    ...
    NO_SUB_LEADERS(HttpStatus.NOT_FOUND, "CR022",
            "해당 크루에 부크루장이 없습니다."),
    NO_ELIGIBLE_LEADERS(HttpStatus.NOT_FOUND, "CR023",
            "크루장 위임이 가능한 부크루장이 없습니다. (프리미엄 멤버십 필요)"),
    ONLY_SUB_LEADER_OR_STAFF_CAN_BE_LEADER(HttpStatus.FORBIDDEN, "CR024",
            "부크루장 또는 운영진만 크루장으로 위임할 수 있습니다."),
    MEMBERSHIP_REQUIRED_FOR_LEADER(HttpStatus.FORBIDDEN, "CR025",
            "크루장은 프리미엄 멤버십이 필요합니다."),
    /* ===== 멤버십 ===== */
