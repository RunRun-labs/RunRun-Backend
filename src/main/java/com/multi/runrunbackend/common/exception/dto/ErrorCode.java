...
public enum ErrorCode {
  ...
  NOT_ENOUGH_PARTICIPANTS(HttpStatus.BAD_REQUEST, "R013", "참가자가 최소 1명은 더 있어야 출발할 수 있습니다."),
  TOO_EARLY_TO_START(HttpStatus.BAD_REQUEST, "R014", "매칭 확정은 모임 시간 3시간 전부터 가능합니다."),
